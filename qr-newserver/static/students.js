...
{
    const response = await fetch('/pk?name=alumnos');
    const data = await response.json();
    return data;
}
...
<div class='col-sm-4'><h3>Gestion de <b>Estudiantes</b></h3></div>
...
<span style="vertical-align:middle;">Eliminar Estudiante(s)</span>
</button>
</div>
</div>
<div class="row">
